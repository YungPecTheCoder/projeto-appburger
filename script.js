...
cartModal.addEventListener("click", function(event){
    // console.log(event) // <--- como saber em qual id foi clicado.
...
menu.addEventListener("click", function(event){
    // console.log(event.target) // <--- como saber exatamente em qual elemento foi clicado.
...
function addToCart(name, price){
    ...
    if(existingItem) {
        existingItem.quantity += 1; // <--- se o item existir, aumentar a quantidade + 1.
    }else{
            cart.push({
            name,
            price,
